...
div1.style.marginRight = "5.6vw", div2.style.marginRight = "5.6vw";
...
function btnHandler() {
    if (startCheck == 0) {
        ...
        var i = (parseInt(centerCell[0].innerText) - 1), j = (parseInt(centerCell[1].innerText) - 1), k = (parseInt(centerCell[2].innerText) - 1);
