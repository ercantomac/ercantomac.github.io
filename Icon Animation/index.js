...
box[1].style.left = "18vh", box[1].style.backgroundImage = "radial-gradient(#f3e500, #f79e1b)";
box[2].style.left = "36vh", box[2].style.backgroundImage = "radial-gradient(mediumspringgreen, #00bf8f)";
box[3].style.top = "18vh", box[3].style.left = "0", box[3].style.backgroundImage = "radial-gradient(purple, indigo)";
box[4].style.top = "18vh", box[4].style.left = "18vh", box[4].style.backgroundImage = "radial-gradient(deeppink, #FF0066)";
box[5].style.top = "18vh", box[5].style.left = "36vh", box[5].style.backgroundImage = "radial-gradient(#12fff7, cornflowerblue)";
