...
/*theText.name = "myText", */theText.contentEditable = "true", theText.setAttribute("data-text", "Write your text here."), theText.spellcheck = 0, theText.cols = "72", theText.rows = "36", theText.className = "theText";
